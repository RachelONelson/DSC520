...
## sex vs. earn
ggplot(heights_df, aes(x=sex, y=earn)) + geom_point()+ geom_boxplot() + ggtitle("Sex vs. Earn") 
## race vs. earn
ggplot(heights_df, aes(x=race, y=earn)) + geom_point()+ geom_boxplot() + ggtitle("Race vs. Earn") 
...
ggplot(data=florida_df, aes(x=date, group=1)) +
  geom_line(aes(y = florida_df$cases, colour = "Florida")) +
